...
![Diagrama de Bloques del Sistema de Control PID](01_pid_block_diagram.png)

*Diagrama de bloques del sistema de control PID mostrando la señal de referencia r(t),
el error e(t), los tres bloques Kp, Ki y Kd en paralelo, la suma de las tres acciones,
la planta G(s), la salida y(t) y el lazo de retroalimentación.*
...
![Comparación de Respuestas al Escalón: P, PI y PID](02_step_response_comparison.png)

*Gráfica de respuesta al escalón unitario comparando tres configuraciones: solo P
(oscilatorio con offset), PI (sin offset pero con sobrepaso) y PID (respuesta
óptima con mínimo sobrepaso). Ejes: tiempo (s) en x, amplitud en y. Incluir
la referencia como línea punteada.*
...
![Panel de Control Industrial Moderno](03_industrial_control_panel.png)

*Fotografía de un panel de control industrial moderno con pantallas HMI mostrando
lazos de control PID en tiempo real, en una planta de procesamiento químico.*
