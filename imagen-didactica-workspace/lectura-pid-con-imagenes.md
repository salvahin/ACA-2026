...
![Gráfica de respuesta al escalón unitario comparando tres configuraciones: solo P (oscilatorio con offset), PI (sin offset pero con sobrepaso) y PID (respuesta óptima con mínimo sobrepaso). Ejes: tiempo (s) en x, amplitud en y. Incluir la referencia como línea punteada.](/sessions/vibrant-compassionate-dijkstra/mnt/TC3002B-2026/imagen-didactica-workspace/imagenes-pid/grafica-de-respuesta-al-escalon-unitario-comparando-tres-con.png)
