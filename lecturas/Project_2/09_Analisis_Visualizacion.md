...
1. Aplicar técnicas de análisis exploratorio a datos de performance
2. Crear visualizaciones efectivas para comparar kernels
3. Identificar patrones y anomalías en benchmarks
4. Generar reportes profesionales de resultados
5. Comunicar hallazgos a diferentes audiencias
...
> **Pipeline de Análisis de Resultados**
>
> El flujo de análisis va desde la recolección de métricas brutas (tiempo, correctness, speedup) hasta visualizaciones comparativas (box plots, heatmaps de parámetros, curvas de escalabilidad) que permiten identificar qué variantes de kernel ganan en qué condiciones.
...
- **Análisis exploratorio**: Limpieza, estadísticas, distribuciones
- **Visualizaciones**: Box plots, scaling, heatmaps, roofline
- **Patrones**: Detección de anomalías e identificación de tendencias
- **Reportes**: Ejecutivos y técnicos
- **Comunicación**: Adaptar para diferentes audiencias
