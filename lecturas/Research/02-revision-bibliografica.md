...
![Estrategia de las Tres Pasadas](./diagrams/tres_pasadas_paper.png)

> **Estrategia de las Tres Pasadas: Lectura Eficiente de Papers Académicos**
>
> Tres paneles secuenciales: Pasada 1 (5-10 min, decisión binaria de relevancia), Pasada 2 (15-20 min, entender contribución principal leyendo intro+figuras+conclusiones), Pasada 3 (profundidad variable, solo para los 5-10 papers esenciales). Panel inferior: distinción Resumen vs. Síntesis con ejemplos concretos del dominio GPU.
