...
![Embudo de Refinamiento de RQs](./diagrams/embudo_rqs.png)

> **Embudo de Refinamiento: De Área General a Preguntas de Investigación Formales**
>
> Embudo de 4 niveles: Área amplia → Problema identificado → Gap de conocimiento → RQ1/RQ2/RQ3 formales con flechas de estrechamiento. Panel inferior: criterios SMART para buenas RQs y plantilla de oración para formularlas.
