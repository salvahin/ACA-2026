...
![Metodología: Componentes Obligatorios y Trampas Comunes](./diagrams/metodologia_checklist.png)

> **Checklist de Metodología: Lo que Debe Estar vs. Lo que Debes Evitar**
>
> Panel izquierdo (verde): 5 componentes obligatorios de toda sección de metodología rigurosa. Panel derecho (rojo): 6 trampas comunes que invalidan la reproducibilidad. Panel inferior: distinción entre "Lo que hice" (narración informal) y "Metodología" (protocolo reproducible con versiones, seeds y criterios de decisión explícitos).
