...
![Estructura del Abstract](./diagrams/abstract_estructura.png)

> **Estructura del Abstract: 5 Componentes en ~250 Palabras**
>
> Pipeline secuencial: ①Contexto (~30 palabras) → ②Objetivo (~25 palabras) → ③Método (~50 palabras) → ④Resultados (~80 palabras) → ⑤Conclusión (~65 palabras). Panel inferior: anti-patrones frecuentes (no empezar con "En este trabajo...", no omitir resultados numéricos, no terminar con trabajo futuro como resultado principal).
