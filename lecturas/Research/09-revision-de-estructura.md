...
![Auditoría de Integridad de la Tesis](./diagrams/auditoria_integridad.png)

> **Auditoría de Integridad: Trazabilidad RQ → Métrica → Resultado → Conclusión**
>
> Matriz de trazabilidad de 4 columnas para RQ1, RQ2 y RQ3 con flechas de conexión. RQ1 y RQ2 muestran alineación completa (verde). RQ3 muestra resultado borderline (ámbar) que requiere más datos. Panel inferior: verificaciones adicionales de consistencia métrica y de hechos citados.
