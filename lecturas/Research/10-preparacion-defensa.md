...
![Arco de la Defensa: 7 Momentos Clave](./diagrams/defensa_presentacion.png)

> **Arco de la Defensa: 7 Momentos Clave con Tiempos Sugeridos**
>
> Pipeline de 7 cajas secuenciales: ①Gancho (1-2 min) → ②Contexto (3-4 min) → ③Método (4-5 min) → ④Resultados (6-8 min, centro de la presentación) → ⑤Discusión (4-5 min) → ⑥Conclusión (2-3 min) → ⑦Preguntas (15-20 min). Panel izquierdo: tipos de preguntas y cómo responder cada tipo. Panel derecho: errores fatales a evitar durante la defensa.
